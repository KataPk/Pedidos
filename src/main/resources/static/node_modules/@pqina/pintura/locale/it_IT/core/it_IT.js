...
export default {
    ...
    labelEdit: 'Modifica',
    labelClose: 'Chiudi',
    labelSupportError: (features) => `${features.join(', ')} non supportate su questo browser`,
    ...
    // controls
    labelColorPalette: 'Palette di colori',

    // sizes
    labelSizeExtraSmall: 'Extra piccolo',
    labelSizeSmall: 'Piccolo',
    labelSizeMediumSmall: 'Medio piccolo',
    labelSizeMedium: 'Medio',
    labelSizeMediumLarge: 'Medio grande',
    labelSizeLarge: 'Grande',
    labelSizeExtraLarge: 'Extra grande',

    // default buttons
    labelButtonCancel: 'Annulla',
    labelButtonUndo: 'Disfare',
    labelButtonRedo: 'Rifare',
    labelButtonRevert: 'Ripristina',
    ...
    labelZoomActual: 'Dimensioni reali',
    ...
    // status
    statusLabelButtonClose: 'Chiudi',
    statusIconButtonClose: IconCross,
    statusLabelLoadImage: (state) => {
        if (!state || !state.task) return 'In attesa di immagine';
        if (state.error)
            return state.error.code === 'IMAGE_TOO_SMALL'
                ? "La dimensione minima dell'immagine è {minWidth} &times; {minHeight}"
                : "Errore durante il caricamento dell'immagine";
        if (state.task === 'blob-to-bitmap') return 'Preparazione immagine in corso&hellip;';
        return 'Caricamento immagine in corso&hellip;';
    },
    // processing status message
    statusLabelProcessImage: (state) => {
        if (!state || !state.task) return undefined;
        if (state.task === 'store') {
            if (state.error) return "Errore durante il caricamento dell'immagine";
            return 'Caricamento immagine in corso&hellip;';
        }
        if (state.error) return "Errore durante l'elaborazione dell'immagine";
        return 'Elaborazione immagine in corso&hellip;';
    },
};

export const MarkupEditor = {
    shapeLabelButtonSelectSticker: 'Seleziona immagine',
    ...
    shapeTitleButtonTextLayoutAutoWidth: 'Larghezza automatica',
    shapeTitleButtonTextLayoutAutoHeight: 'Altezza automatica',
    shapeTitleButtonTextLayoutFixedSize: 'Dimensione fissa',

    shapeTitleButtonFlipHorizontal: 'Capovolgi orizzontalmente',
    shapeTitleButtonFlipVertical: 'Capovolgi verticalmente',
    shapeTitleButtonRemove: 'Rimuovi',
    shapeTitleButtonDuplicate: 'Duplica',
    shapeTitleButtonMoveToFront: 'Sposta in primo piano',

    shapeLabelInputText: 'Modifica',
    ...
    shapeLabelInputCancel: 'Annulla',
    shapeLabelInputConfirm: 'Conferma',

    shapeLabelStrokeNone: 'Nessun contorno',

    shapeLabelFontStyleNormal: 'Normale',
    shapeLabelFontStyleBold: 'Grassetto',
    shapeLabelFontStyleItalic: 'Corsivo',
    shapeLabelFontStyleItalicBold: 'Grassetto corsivo',

    shapeTitleBackgroundColor: 'Colore di riempimento',

    shapeTitleCornerRadius: "Raggio dell'angolo",

    shapeTitleFontFamily: 'Font',
    shapeTitleFontSize: 'Dimensione del font',
    shapeTitleFontStyle: 'Stile del font',
    shapeTitleLineHeight: 'Altezza della riga',

    shapeTitleLineStart: 'Inizio',
    shapeTitleLineEnd: 'Fine',
    shapeTitleStrokeWidth: 'Spessore della linea',
    shapeTitleStrokeColor: 'Colore della linea',

    shapeTitleLineDecorationBar: 'Barra',
    shapeTitleLineDecorationCircle: 'Cerchio',
    shapeTitleLineDecorationSquare: 'Quadrato',
    shapeTitleLineDecorationArrow: 'Freccia',
    shapeTitleLineDecorationCircleSolid: 'Cerchio pieno',
    shapeTitleLineDecorationSquareSolid: 'Quadrato pieno',
    shapeTitleLineDecorationArrowSolid: 'Freccia piena',
    ...
    shapeTitleColorTransparent: 'Trasparente',
    shapeTitleColorWhite: 'Bianco',
    shapeTitleColorSilver: 'Argento',
    shapeTitleColorGray: 'Grigio',
    shapeTitleColorBlack: 'Nero',
    shapeTitleColorNavy: 'Blu scuro',
    shapeTitleColorBlue: 'Blu',
    shapeTitleColorAqua: 'Acqua',
    shapeTitleColorTeal: 'Teal',
    shapeTitleColorOlive: 'Oliva',
    shapeTitleColorGreen: 'Verde',
    shapeTitleColorYellow: 'Giallo',
    shapeTitleColorOrange: 'Arancione',
    shapeTitleColorRed: 'Rosso',
    shapeTitleColorMaroon: 'Marrone',
    shapeTitleColorFuchsia: 'Fucsia',
    shapeTitleColorPurple: 'Porpora',

    shapeTitleTextColor: 'Colore del font',
    shapeTitleTextAlign: 'Allineamento del testo',
    shapeTitleTextAlignLeft: 'Allinea a sinistra il testo',
    shapeTitleTextAlignCenter: 'Centra il testo',
    shapeTitleTextAlignRight: 'Allinea a destra il testo',
    ...
    shapeLabelToolMove: 'Sposta',
    shapeLabelToolView: 'Visualizza',
    shapeLabelToolSharpie: 'Pennarello',
    shapeLabelToolEraser: 'Cancellino',
    shapeLabelToolPath: 'Percorso',
    shapeLabelToolRectangle: 'Rettangolo',
    shapeLabelToolEllipse: 'Ellisse',
    shapeLabelToolArrow: 'Freccia',
    shapeLabelToolLine: 'Linea',
    shapeLabelToolText: 'Testo',
    shapeLabelToolPreset: 'Adesivi',
    ...
    shapeTitleSelectionMode: 'Modalità di selezione',
    shapeTitleBrushSize: 'Dimensione del pennello',

    shapeLabelSelectionModeNew: 'Nuovo',
    shapeLabelSelectionModeAdd: 'Aggiungi',
    shapeLabelSelectionModeSubtract: 'Rimuovi',

    shapeLabelToolSelectionBrush: 'Pennello',
