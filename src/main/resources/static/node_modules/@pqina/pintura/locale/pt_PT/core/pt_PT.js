...
export default {
    ...
    labelEdit: 'Editar',
    labelClose: 'Fechar',
    labelSupportError: (features) => `${features.join(', ')} não é suportado neste navegador`,
    ...
    labelAmount: 'Quantidade',
    labelInset: 'Reentrância',
    labelRadius: 'Raio',

    // controls
    labelColorPalette: 'Paleta de cores',

    // sizes
    labelSizeExtraSmall: 'Extra pequeno',
    labelSizeSmall: 'Pequeno',
    labelSizeMediumSmall: 'Médio pequeno',
    labelSizeMedium: 'Médio',
    labelSizeMediumLarge: 'Médio grande',
    ...
    labelButtonUndo: 'Desfazer',
    labelButtonRedo: 'Refazer',
    labelButtonRevert: 'Reverter',
    ...
    // status
    statusLabelButtonClose: 'Fechar',
    statusIconButtonClose: IconCross,

    statusLabelLoadImage: (state) => {
        if (!state || !state.task) return 'Aguardando imagem';
        if (state.error)
            return state.error.code === 'IMAGE_TOO_SMALL'
                ? 'O tamanho mínimo da imagem é {minWidth} &times; {minHeight}'
                : 'Erro ao carregar a imagem';
        if (state.task === 'blob-to-bitmap') return 'Preparando imagem&hellip;';
        return 'Carregando imagem&hellip;';
    },
    ...
    statusLabelProcessImage: (state) => {
        ...
        if (state.task === 'store') {
            if (state.error) return 'Erro ao enviar imagem';
            return 'Enviando imagem&hellip;';
        }
        if (state.error) return 'Erro ao processar imagem';
        return 'Processando imagem&hellip;';
    },
};

export const MarkupEditor = {
    shapeLabelButtonSelectSticker: 'Selecionar imagem',
    ...
    shapeTitleButtonTextLayoutAutoWidth: 'Largura automática',
    shapeTitleButtonTextLayoutAutoHeight: 'Altura automática',
    shapeTitleButtonTextLayoutFixedSize: 'Tamanho fixo',

    shapeTitleButtonFlipHorizontal: 'Inverter horizontalmente',
    shapeTitleButtonFlipVertical: 'Inverter verticalmente',
    shapeTitleButtonRemove: 'Remover',
    shapeTitleButtonDuplicate: 'Duplicar',
    shapeTitleButtonMoveToFront: 'Mover para frente',
    ...
    shapeLabelStrokeNone: 'Sem contorno',

    shapeLabelFontStyleNormal: 'Normal',
    shapeLabelFontStyleBold: 'Negrito',
    shapeLabelFontStyleItalic: 'Itálico',
    shapeLabelFontStyleItalicBold: 'Itálico negrito',

    shapeTitleBackgroundColor: 'Cor de preenchimento',

    shapeTitleCornerRadius: 'Raio do canto',

    shapeTitleFontFamily: 'Fonte',
    shapeTitleFontSize: 'Tamanho da fonte',
    shapeTitleFontStyle: 'Estilo da fonte',
    shapeTitleLineHeight: 'Altura da linha',

    shapeTitleLineStart: 'Iniciar',
    shapeTitleLineEnd: 'Terminar',
    shapeTitleStrokeWidth: 'Largura da linha',
    shapeTitleStrokeColor: 'Cor da linha',

    shapeTitleLineDecorationBar: 'Barra',
    shapeTitleLineDecorationCircle: 'Círculo',
    shapeTitleLineDecorationSquare: 'Quadrado',
    shapeTitleLineDecorationArrow: 'Seta',
    shapeTitleLineDecorationCircleSolid: 'Círculo sólido',
    shapeTitleLineDecorationSquareSolid: 'Quadrado sólido',
    shapeTitleLineDecorationArrowSolid: 'Seta sólida',
    ...
    shapeTitleColorWhite: 'Branco',
    shapeTitleColorSilver: 'Prata',
    shapeTitleColorGray: 'Cinza',
    shapeTitleColorBlack: 'Preto',
    shapeTitleColorNavy: 'Marinho',
    shapeTitleColorBlue: 'Azul',
    shapeTitleColorAqua: 'Aqua',
    shapeTitleColorTeal: 'Verde-azulado',
    shapeTitleColorOlive: 'Oliva',
    shapeTitleColorGreen: 'Verde',
    shapeTitleColorYellow: 'Amarelo',
    shapeTitleColorOrange: 'Laranja',
    shapeTitleColorRed: 'Vermelho',
    shapeTitleColorMaroon: 'Bordô',
    shapeTitleColorFuchsia: 'Fúcsia',
    shapeTitleColorPurple: 'Roxo',

    shapeTitleTextColor: 'Cor do texto',
    shapeTitleTextAlign: 'Alinhar texto',
    shapeTitleTextAlignLeft: 'Alinhar à esquerda',
    shapeTitleTextAlignCenter: 'Centralizar',
    shapeTitleTextAlignRight: 'Alinhar à direita',
    ...
    shapeLabelToolView: 'Visualizar',
    shapeLabelToolSharpie: 'Marcador',
    shapeLabelToolEraser: 'Borracha',
    shapeLabelToolPath: 'Caminho',
    shapeLabelToolRectangle: 'Retângulo',
    shapeLabelToolEllipse: 'Elipse',
    shapeLabelToolArrow: 'Seta',
    shapeLabelToolLine: 'Linha',
    shapeLabelToolText: 'Texto',
    shapeLabelToolPreset: 'Adesivos',
    ...
    shapeTitleSelectionMode: 'Modo de seleção',
    shapeTitleBrushSize: 'Tamanho do pincel',

    shapeLabelSelectionModeNew: 'Novo',
    shapeLabelSelectionModeAdd: 'Adicionar',
    shapeLabelSelectionModeSubtract: 'Remover',
