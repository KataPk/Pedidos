...
export default {
    ...
    labelEdit: 'Redigera',
    labelClose: 'Stäng',
    labelSupportError: (features) => `${features.join(', ')} stöds inte på den här webbläsaren`,

    // defaults
    labelColor: 'Färg',
    labelWidth: 'Bredd',
    labelSize: 'Storlek',
    labelOffset: 'Förskjutning',
    labelAmount: 'Mängd',
    labelInset: 'Insats',
    labelRadius: 'Radie',

    // controls
    labelColorPalette: 'Färgpalett',

    // sizes
    labelSizeExtraSmall: 'Extra liten',
    labelSizeSmall: 'Liten',
    labelSizeMediumSmall: 'Medium liten',
    labelSizeMedium: 'Medium',
    labelSizeMediumLarge: 'Medium stor',
    labelSizeLarge: 'Stor',
    labelSizeExtraLarge: 'Extra stor',

    // default buttons

    labelButtonCancel: 'Avbryt',
    labelButtonUndo: 'Ångra',
    labelButtonRedo: 'Gör om',
    labelButtonRevert: 'Återgå',
    ...
    labelZoomActual: 'Verklig storlek',
    ...
    statusLabelLoadImage: (state) => {
        if (!state || !state.task) return 'Väntar på bild';
        if (state.error)
            return state.error.code === 'IMAGE_TOO_SMALL'
                ? 'Minsta bildstorlek är {minWidth} &times; {minHeight}'
                : 'Fel vid laddning av bild';
        if (state.task === 'blob-to-bitmap') return 'Förbereder bild&hellip;';
        return 'Laddar bild&hellip;';
    },
    ...
    statusLabelProcessImage: (state) => {
        ...
        if (state.task === 'store') {
            if (state.error) return 'Fel vid uppladdning av bild';
            return 'Laddar upp bild&hellip;';
        }
        if (state.error) return 'Fel vid behandling av bild';
        return 'Bearbetar bild&hellip;';
    },
};

export const MarkupEditor = {
    shapeLabelButtonSelectSticker: 'Välj bild',
    ...
    shapeTitleButtonTextLayoutAutoWidth: 'Automatisk bredd',
    shapeTitleButtonTextLayoutAutoHeight: 'Automatisk höjd',
    shapeTitleButtonTextLayoutFixedSize: 'Fast storlek',

    shapeTitleButtonFlipHorizontal: 'Vänd horisontellt',
    shapeTitleButtonFlipVertical: 'Vänd vertikalt',
    shapeTitleButtonRemove: 'Ta bort',
    shapeTitleButtonDuplicate: 'Duplicera',
    shapeTitleButtonMoveToFront: 'Flytta framåt',

    shapeLabelInputText: 'Redigera text',
    ...
    shapeLabelInputCancel: 'Avbryt',
    shapeLabelInputConfirm: 'Bekräfta',

    shapeLabelStrokeNone: 'Ingen kant',

    shapeLabelFontStyleNormal: 'Normal',
    shapeLabelFontStyleBold: 'Fet',
    shapeLabelFontStyleItalic: 'Kursiv',
    shapeLabelFontStyleItalicBold: 'Fet kursiv',

    shapeTitleBackgroundColor: 'Fyllningsfärg',

    shapeTitleCornerRadius: 'Hörnradie',

    shapeTitleFontFamily: 'Typsnitt',
    shapeTitleFontSize: 'Typsnittstorlek',
    shapeTitleFontStyle: 'Typsnittsstil',
    shapeTitleLineHeight: 'Linjehöjd',

    shapeTitleLineStart: 'Start',
    shapeTitleLineEnd: 'Slut',
    shapeTitleStrokeWidth: 'Linjebredd',
    shapeTitleStrokeColor: 'Linjefärg',

    shapeTitleLineDecorationBar: 'Linje',
    shapeTitleLineDecorationCircle: 'Cirkel',
    shapeTitleLineDecorationSquare: 'Fyrkant',
    shapeTitleLineDecorationArrow: 'Pil',
    shapeTitleLineDecorationCircleSolid: 'Fylld cirkel',
    shapeTitleLineDecorationSquareSolid: 'Fylld fyrkant',
    shapeTitleLineDecorationArrowSolid: 'Fylld pil',
    ...
    shapeTitleColorWhite: 'Vit',
    shapeTitleColorSilver: 'Silver',
    shapeTitleColorGray: 'Grå',
    shapeTitleColorBlack: 'Svart',
    shapeTitleColorNavy: 'Marinblå',
    shapeTitleColorBlue: 'Blå',
    shapeTitleColorAqua: 'Aquagrön',
    shapeTitleColorTeal: 'Blågrön',
    shapeTitleColorOlive: 'Olivgrön',
    shapeTitleColorGreen: 'Grön',
    shapeTitleColorYellow: 'Gul',
    shapeTitleColorOrange: 'Orange',
    shapeTitleColorRed: 'Röd',
    shapeTitleColorMaroon: 'Brunröd',
    shapeTitleColorFuchsia: 'Fuchsia',
    shapeTitleColorPurple: 'Lila',

    shapeTitleTextColor: 'Typsnittsfärg',
    shapeTitleTextAlign: 'Textjustering',
    shapeTitleTextAlignLeft: 'Vänsterjusterad text',
    shapeTitleTextAlignCenter: 'Centrerad text',
    shapeTitleTextAlignRight: 'Högerjusterad text',
    ...
    shapeLabelToolEllipse: 'Ellips',
    shapeLabelToolArrow: 'Pil',
    shapeLabelToolLine: 'Linje',
    shapeLabelToolText: 'Text',
    shapeLabelToolPreset: 'Bilder',
    ...
    shapeTitleSelectionMode: 'Urvalsläge',
    shapeTitleBrushSize: 'Penselstorlek',

    shapeLabelSelectionModeNew: 'Ny',
    shapeLabelSelectionModeAdd: 'Lägg till',
    shapeLabelSelectionModeSubtract: 'Ta bort',

    shapeLabelToolSelectionBrush: 'Pensel',
