...
export const MarkupEditor = {
    ...
    shapeTitleSelectionMode: 'Режим выбора',
    shapeTitleBrushSize: 'Размер кисти',

    shapeLabelSelectionModeNew: 'Новый',
    shapeLabelSelectionModeAdd: 'Добавить',
    shapeLabelSelectionModeSubtract: 'Удалить',

    shapeLabelToolSelectionBrush: 'Кисть',
