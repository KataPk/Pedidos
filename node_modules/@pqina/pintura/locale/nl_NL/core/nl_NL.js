...
export default {
    ...
    labelEdit: 'Bewerken',
    labelClose: 'Sluiten',
    labelSupportError: (features) => `${features.join(', ')} niet ondersteund op deze browser`,
    ...
    // controls
    labelColorPalette: 'Kleurenpalet',

    // sizes
    labelSizeExtraSmall: 'Extra klein',
    labelSizeSmall: 'Klein',
    labelSizeMediumSmall: 'Gemiddeld klein',
    labelSizeMedium: 'Gemiddeld',
    labelSizeMediumLarge: 'Gemiddeld groot',
    labelSizeLarge: 'Groot',
    labelSizeExtraLarge: 'Extra groot',

    // default buttons
    labelButtonCancel: 'Annuleren',
    labelButtonUndo: 'ongedaan maken',
    labelButtonRedo: 'Opnieuw doen',
    labelButtonRevert: 'Terugdraaien',
    ...
    // status
    statusLabelButtonClose: 'Sluiten',
    statusIconButtonClose: IconCross,
    statusLabelLoadImage: (state) => {
        if (!state || !state.task) return 'Wacht op afbeelding';
        if (state.error)
            return state.error.code === 'IMAGE_TOO_SMALL'
                ? 'Minimale afbeelding grootte is {minWidth} &times; {minHeight}'
                : 'Probleem met laden afbeelding';
        if (state.task === 'blob-to-bitmap') return 'Bezig met voorbereiden afbeelding&hellip;';
        return 'Bezig met laden afbeelding&hellip;';
    },
    ...
    statusLabelProcessImage: (state) => {
        ...
        if (state.task === 'store') {
            if (state.error) return 'Probleem met uploaden van afbeelding';
            return 'Afbeelding aan het uploaden&hellip;';
        }
        if (state.error) return 'Probleem met verwerken van afbeelding';
        return 'Bezig met verwerken van afbeelding&hellip;';
    },
};

export const MarkupEditor = {
    shapeLabelButtonSelectSticker: 'Afbeelding selecteren',
    ...
    shapeTitleButtonTextLayoutAutoWidth: 'Automatische breedte',
    shapeTitleButtonTextLayoutAutoHeight: 'Automatische hoogte',
    shapeTitleButtonTextLayoutFixedSize: 'Vaste afmetingen',

    shapeTitleButtonFlipHorizontal: 'Spiegel Horizontaal',
    shapeTitleButtonFlipVertical: 'Spiegel Verticaal',
    shapeTitleButtonRemove: 'Verwijderen',
    shapeTitleButtonDuplicate: 'Dupliceren',
    shapeTitleButtonMoveToFront: 'Naar voren verplaatsen',

    shapeLabelInputText: 'Text bewerken',
    ...
    shapeLabelInputCancel: 'Annuleren',
    shapeLabelInputConfirm: 'Bevestigen',

    shapeLabelStrokeNone: 'Geen rand',
    ...
    shapeTitleBackgroundColor: 'Achtergrond kleur',
    shapeTitleCornerRadius: 'Hoekradius',

    shapeTitleFontFamily: 'Lettertype',
    shapeTitleFontSize: 'Lettertype grootte',
    shapeTitleFontStyle: 'Lettertype stijl',
    shapeTitleLineHeight: 'Lijnhoogte',

    shapeTitleLineStart: 'Start',
    shapeTitleLineEnd: 'Eind',
    shapeTitleStrokeWidth: 'Lijn dikte',
    shapeTitleStrokeColor: 'Lijn kleur',

    shapeTitleLineDecorationBar: 'Balk',
    shapeTitleLineDecorationCircle: 'Circel',
    shapeTitleLineDecorationSquare: 'Vierkant',
    shapeTitleLineDecorationArrow: 'Pijl',
    shapeTitleLineDecorationCircleSolid: 'Circel gevuld',
    shapeTitleLineDecorationSquareSolid: 'Vierkant gevuld',
    shapeTitleLineDecorationArrowSolid: 'Pijl gevuld',
    ...
    shapeTitleColorTransparent: 'Transparant',
    shapeTitleColorWhite: 'Wit',
    shapeTitleColorSilver: 'Zilver',
    shapeTitleColorGray: 'Grijs',
    shapeTitleColorBlack: 'Zwart',
    shapeTitleColorNavy: 'Marine',
    shapeTitleColorBlue: 'Blauw',
    shapeTitleColorAqua: 'Water',
    shapeTitleColorTeal: 'Groenblauw',
    shapeTitleColorOlive: 'Olijf',
    shapeTitleColorGreen: 'Groen',
    shapeTitleColorYellow: 'Geel',
    shapeTitleColorOrange: 'Oranje',
    shapeTitleColorRed: 'Rood',
    shapeTitleColorMaroon: 'Kastanjebruin',
    shapeTitleColorFuchsia: 'Fuchsia',
    shapeTitleColorPurple: 'Paars',

    shapeTitleTextColor: 'Lettertype kleur',
    shapeTitleTextAlign: 'Tekst uitlijning',
    shapeTitleTextAlignLeft: 'Tekst links uitlijnen',
    shapeTitleTextAlignCenter: 'Tekst midden uitlijnen',
    shapeTitleTextAlignRight: 'Tekst rechts uitlijnen',
    ...
    shapeLabelToolMove: 'Verplaatsen',
    shapeLabelToolView: 'Bekijken',
    shapeLabelToolSharpie: 'Sharpie',
    shapeLabelToolEraser: 'Gom',
    shapeLabelToolPath: 'Pad',
    shapeLabelToolRectangle: 'Rechthoek',
    shapeLabelToolEllipse: 'Ovaal',
    shapeLabelToolArrow: 'Pijl',
    shapeLabelToolLine: 'Lijn',
    ...
    shapeTitleSelectionMode: 'Selectiemodus',
    shapeTitleBrushSize: 'Penseelgrootte',

    shapeLabelSelectionModeNew: 'Nieuw',
    shapeLabelSelectionModeAdd: 'Toevoegen',
    shapeLabelSelectionModeSubtract: 'Verwijderen',
