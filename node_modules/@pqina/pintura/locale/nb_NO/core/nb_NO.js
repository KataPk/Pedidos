...
export default {
    ...
    labelEdit: 'Rediger',
    labelClose: 'Lukk',
    labelSupportError: (features) => `${features.join(', ')} støttes ikke på denne nettleseren`,
    labelColor: 'Farge',
    labelWidth: 'Bredde',
    labelSize: 'Størrelse',
    labelOffset: 'Forskyvning',
    labelAmount: 'Mengde',
    labelInset: 'Innsetting',
    labelRadius: 'Radius',
    labelColorPalette: 'Fargepalett',
    labelSizeExtraSmall: 'Ekstra liten',
    ...
    labelZoomActual: 'Faktisk størrelse',
    ...
    // status
    statusLabelButtonClose: 'Lukk',
    statusIconButtonClose: IconCross,
    statusLabelLoadImage: (state) => {
        if (!state || !state.task) return 'Venter på bilde';
        if (state.error)
            return state.error.code === 'IMAGE_TOO_SMALL'
                ? 'Minimum bildestørrelse er {minWidth} &times; {minHeight}'
                : 'Feil ved lasting av bilde';
        if (state.task === 'blob-to-bitmap') return 'Forbereder bilde&hellip;';
        return 'Laster bilde&hellip;';
    },
    statusLabelProcessImage: (state) => {
        if (!state || !state.task) return undefined;
        if (state.task === 'store') {
            if (state.error) return 'Feil ved opplasting av bilde';
            return 'Laster opp bilde&hellip;';
        }
        if (state.error) return 'Feil ved behandling av bilde';
        return 'Behandler bilde&hellip;';
    },
};

export const MarkupEditor = {
    shapeLabelButtonSelectSticker: 'Velg bilde',
    ...
    shapeTitleButtonTextLayoutAutoWidth: 'Auto bredde',
    shapeTitleButtonTextLayoutAutoHeight: 'Auto høyde',
    shapeTitleButtonTextLayoutFixedSize: 'Fast størrelse',

    shapeTitleButtonFlipHorizontal: 'Vend horisontalt',
    shapeTitleButtonFlipVertical: 'Vend vertikalt',
    shapeTitleButtonRemove: 'Fjern',
    shapeTitleButtonDuplicate: 'Dupliser',
    shapeTitleButtonMoveToFront: 'Flytt til forgrunnen',
    ...
    shapeLabelInputConfirm: 'Bekreft',

    shapeLabelStrokeNone: 'Ingen ramme',
    ...
    shapeTitleBackgroundColor: 'Fyllfarge',

    shapeTitleCornerRadius: 'Hjørne radius',

    shapeTitleFontFamily: 'Skrift',
    shapeTitleFontSize: 'Skriftstørrelse',
    shapeTitleFontStyle: 'Skriftstil',
    shapeTitleLineHeight: 'Linje høyde',

    shapeTitleLineStart: 'Start',
    shapeTitleLineEnd: 'Slutt',
    shapeTitleStrokeWidth: 'Linjebredde',
    shapeTitleStrokeColor: 'Linjefarge',

    shapeTitleLineDecorationBar: 'Linje',
    shapeTitleLineDecorationCircle: 'Sirkel',
    shapeTitleLineDecorationSquare: 'Firkant',
    shapeTitleLineDecorationArrow: 'Pil',
    shapeTitleLineDecorationCircleSolid: 'Fylt sirkel',
    shapeTitleLineDecorationSquareSolid: 'Fylt firkant',
    shapeTitleLineDecorationArrowSolid: 'Fylt pil',
    ...
    shapeTitleColorTransparent: 'Gjennomsiktig',
    shapeTitleColorWhite: 'Hvit',
    ...
    shapeTitleColorAqua: 'Turkis',
    shapeTitleColorTeal: 'Blågrønn',
    shapeTitleColorOlive: 'Oliven',
    shapeTitleColorGreen: 'Grønn',
    shapeTitleColorYellow: 'Gul',
    shapeTitleColorOrange: 'Oransje',
    shapeTitleColorRed: 'Rød',
    shapeTitleColorMaroon: 'Rødbrun',
    shapeTitleColorFuchsia: 'Fuchsia',
    shapeTitleColorPurple: 'Lilla',

    shapeTitleTextColor: 'Skriftfarge',
    shapeTitleTextAlign: 'Tekstjustering',
    shapeTitleTextAlignLeft: 'Venstrejuster tekst',
    shapeTitleTextAlignCenter: 'Midtstill tekst',
    shapeTitleTextAlignRight: 'Høyrejuster tekst',
    ...
    shapeLabelToolMove: 'Flytt',
    shapeLabelToolView: 'Vis',
    shapeLabelToolSharpie: 'Tusj',
    shapeLabelToolEraser: 'Slett',
    shapeLabelToolPath: 'Sti',
    ...
    shapeTitleSelectionMode: 'Utvalgsmodus',
    shapeTitleBrushSize: 'Penselstørrelse',

    shapeLabelSelectionModeNew: 'Ny',
    shapeLabelSelectionModeAdd: 'Legg til',
    shapeLabelSelectionModeSubtract: 'Fjern',
