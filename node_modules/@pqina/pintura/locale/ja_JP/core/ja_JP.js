...
export const MarkupEditor = {
    ...
    shapeTitleSelectionMode: '選択モード',
    shapeTitleBrushSize: 'ブラシのサイズ',

    shapeLabelSelectionModeNew: '新しい',
    shapeLabelSelectionModeAdd: '追加',
    shapeLabelSelectionModeSubtract: '削除',

    shapeLabelToolSelectionBrush: 'ブラシ',
